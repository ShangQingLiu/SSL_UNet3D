...
class SSLDataset(Dataset):
    ...
    def compose_action(self, file_name, type='img'):
        ...
        if type=='label':
            ...
            data = zero_data
            #FIXME: Visualize, make sure is correct class of label
        ...
        if epoch %10 == 0:
            ...
            with torch.no_grad():
                for val_batch in val_loader:
                    ...
                    val_loss,val_sup_loss,val_query_loss = MyLoss(val_sup_fg_label,val_sup_bg_label,
                    val_qry_label_fg,val_qry_label_bg, val_prediction["qry_fts"],val_prediction["sup_fts"],model_param,writer) 
